...
class JamaClient:
    ...
    def get_test_groups(self, test_plan_id):
        """
        This method will return the JSON data about the test groups specified under the test plan
        :param test_plan_id: int
        :return: a dictionary object that represents the test groups
        """
        resource = f"testplans/{test_plan_id}/testgroups"
        response = self.__get_all(resource)
        return response
    ...
    def post_test_group(self, testplan_id, testgroup_name, assign_to=None):
        """

        :param testplan_id:
        :param testgroup_name:
        :param assign_to:
        :return:
        """

        resource_path = 'testplans/%s/testgroups' % testplan_id

        body = {'name': testgroup_name,
